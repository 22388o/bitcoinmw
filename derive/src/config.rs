...
impl MacroState {
	...
	fn build_options_enum(&self) -> String {
		...
		for config in &self.u128_configs {
			ret = format!(
				"{}{}{}",
				ret,
				format!("\n\t/// Auto-generated [`prim@u128`] field."),
		...
		for config in &self.usize_configs {
			ret = format!(
				"{}{}{}",
				ret,
				format!("\n\t/// Auto-generated [`prim@usize`] field."),
		...
		for config in &self.string_configs {
			ret = format!(
				"{}{}{}",
				ret,
				format!("\n\t/// Auto-generated [`std::string::String`] field."),
		...
		for config in &self.bool_configs {
			ret = format!(
				"{}{}{}",
				ret,
				format!("\n\t/// Auto-generated [`prim@bool`] field."),
	...
	fn ret(&self) -> String {
		match &self.name {
			...
			\n\
                        /// This enum was generated by the [`bmw_derive::Configurable`] proc-macro\n\
